...
public class Manager {
    ...
    public Manager(NaveJugador nave, Sound explosionSound, Sound herida, NaveEnem naveEnem, ArrayList<Ball2> balls1, ArrayList<Ball2> balls2, ArrayList<Bullet> balas) {
        this.nave = nave;
